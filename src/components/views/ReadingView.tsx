        ...
        <div>
          ...
          <div className="flex items-center gap-2 mt-1">
            ...
            <select
              ...
              className="text-xs ml-2 font-sans font-bold bg-bible-secondary text-bible-text px-2 py-1 rounded border border-bible-border cursor-pointer hover:border-bible-accent focus:outline-none focus:border-bible-accent transition-colors"
            >
